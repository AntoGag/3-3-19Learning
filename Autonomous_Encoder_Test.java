...
public class Autonomous_Encoder_Test extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        //Beginning Of Move Forward
            ...
            //Set Position
            FrontLeft.setTargetPosition((int) (SingleR*9.55));
            FrontRight.setTargetPosition((int) (SingleR*9.55));
            BackLeft.setTargetPosition((int) (SingleR*9.55));
            BackRight.setTargetPosition((int) (SingleR*9.55));
            //Run To Position
